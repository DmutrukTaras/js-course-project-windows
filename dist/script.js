...
window.addEventListener('DOMContentLoaded', function () {
  ...
  _modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"].modals();
  _modules_modal__WEBPACK_IMPORTED_MODULE_1__["default"].test();
  ...
  function tab(headerSelector, tabSelector, contentSelector, activeClass) {
    ...
    function hideTabContent() {
      ...
      for (var _i = 0; _i < tabsLink.length; _i++) {
        tabsLink[_i].classList.remove(activeClass);
      }
    }
